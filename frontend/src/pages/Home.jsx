...
export default function Home() {
    ...
    const handleClick = (event) => {
        if(toggle) {
            ...
            setVisibleCourses(courses.slice(0, 5));
        }
        setToggle(1 - toggle);
    };
        ...
        height:'100vh'
            ...
            >
                ...
                <Box sx={{paddingLeft:'0.5rem', paddingRight:'0.5rem'}}>
                    <Button fullWidth variant="outlined" onClick={handleClick}>{toggle ? "View More Classes" : "Truncate"}</Button>
                </Box>
            </List>
            </Card>
            </Box>
